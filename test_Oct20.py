...
num_epochs = 400
print_interval = 10
d_steps = 200  # 'k' steps in the original GAN paper. Can put the discriminator on higher training freq than generator
g_steps = 200
...
print(generator_strategy(G_queue,d_input_size))
